...
console.log("quebrar ovos");
console.log("jogar casca de ovo fora");
console.log("separar gema da clara");


setTimeout(() => {
  console.log("clara de ovo em neve")
}, 2000);

console.log("bater os ovos");

//acho que a ordem vai ser: quebrar ovos, jogar casca do ovo fora, bater os ovos, clara de ovo em neve
